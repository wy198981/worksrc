...
//                "http://localhost:8080/strurts2fileupload/uploadAction");
    ...
    public static String uploadForm(
            Map<String, String> params, String fileFormName,
     ...
     * @throws IOException
     */
    public static void uploadFromBySocket(
    ...
    // new FileUploadUtil().uploadForm(null, "uploadFile", file1, "picture.jpg", resultURL);
    public static String uploadBitmap(
            Map<String, String> params, Bitmap bit, String urlStr
    ) throws IOException
    {
        L.i("urlStr: " + urlStr);
        ...
        // 将bitmap转换InputStream
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        boolean compress = bit.compress(Bitmap.CompressFormat.JPEG, 100, baos);
        if (compress == false)
        {
            Log.i(TAG, "bit.compress failed");
            return null;
        }
        int bitmapSize = baos.size();
        L.i("bitmapSize:" + bitmapSize);
        ...
        conn.setRequestProperty("Content-Length", String
                .valueOf(headerInfo.length + bitmapSize
                        + endInfo.length));
        conn.setDoOutput(true);
