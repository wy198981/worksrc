...
public class GetXXXCommonReq
{
    ...
    public GetXXXCommonReq()
    {

    }

    public GetXXXCommonReq(String token, String jsonModel, String jsonSearchParam, Integer pageSize, Integer page, String orderField, String exportFields, String callBack)
    {
        this.token = token;
    ...
    {
        final StringBuffer sb = new StringBuffer("GetXXXCommonReq{");
