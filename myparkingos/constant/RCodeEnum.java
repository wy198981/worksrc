...
public enum RCodeEnum
{
    ...
    {
        final StringBuffer sb = new StringBuffer("RCodeEnum{");
        sb.append("value(").append(value);
        sb.append('}');
        return sb.toString();
    }

    public static RCodeEnum valueOf(int value) //    手写的从int到enum的转换函数
    {
        switch (value)
        {
            case -3:
